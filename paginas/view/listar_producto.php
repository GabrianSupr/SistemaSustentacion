...
<html lang="es">
    ...
    echo str_replace('href="assets/', 'href="../assets/', $assetsLoader->getCssLinks01());
    echo str_replace('href="assets/', 'href="../assets/', $assetsLoader->getFavicons01());
...
<?php
    echo str_replace('href="assets/', 'href="../assets/', $assetsLoader->getJsScripts01());
  ?>
